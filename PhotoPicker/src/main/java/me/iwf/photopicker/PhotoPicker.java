...
public class PhotoPicker {
    ...
    public static class PhotoPickerBuilder {
        ...
        public void start(@NonNull Fragment fragment, @NonNull Activity activity) {
            if (mPickerOptionsBundle.getBoolean(EXTRA_OPEN_CROP, false) || mPickerOptionsBundle.getBoolean(EXTRA_OPEN_CAMERA, false)) {
                start(fragment,activity, CROP_CODE);
            } else {
                start(fragment,activity, REQUEST_CODE);
            }
        }

        public void start(@NonNull Fragment fragment,@NonNull Activity activity, int requestCode) {
            if (PermissionsUtils.checkReadStoragePermission(activity)) {
